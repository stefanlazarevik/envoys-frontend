...
export default {
  ...
  lang_346: 'Pass KYC verification',
  lang_347: 'The goal of KYC is to prevent fraud, comply with international regulations, and connect only trusted users. A thorough KYC policy creates a reputation for a safe and reliable company, as well as unlocks all available trading platform tools.',
  lang_348: 'Please wait, the verification process has begun',
  lang_349: 'Identity verification was successfully completed',
  lang_350: 'You are verified',
  lang_351: 'Enable KYC and remove all available limits',
